...
void VeterinarioManager::listarVeterinarios() {
    ...
    for (int i = 0; i < cantidad; i++) {
        ...
        mostrar(veterinario, posY);
        posY += 8;
    }
}

void VeterinarioManager::mostrar(Veterinario veterinario, int posY) {
    Interfaz interfaz;

    if (veterinario.getEstado()) {

        interfaz.moverCursor(4, posY);
        cout << "Legajo";
        interfaz.moverCursor(8, posY += 2);
        cout << veterinario.getLegajo() << endl;
        interfaz.moverCursor(14, posY -= 2);
        cout << "Nombre";
        interfaz.moverCursor(11, posY += 2);
        cout << veterinario.getNombre() << endl;
        interfaz.moverCursor(30, posY -= 2);
        cout << "Telefono";
        interfaz.moverCursor(32, posY += 2);
        cout << veterinario.getTelefono() << endl;
        interfaz.moverCursor(47, posY -= 2);
        cout << "Email";
        interfaz.moverCursor(43, posY += 2);
        cout << veterinario.getEmail() << endl;
        interfaz.moverCursor(70, posY -= 2);
        cout << "Direccion";
        interfaz.moverCursor(67, posY += 2);
        cout << veterinario.getDireccion() << endl;
        //interfaz.moverCursor(18, 8);
        //cout << "Fecha y Hora";
        //interfaz.moverCursor(77, 2);
        //cout << veterinario.getFechaHora().mostrarFechaHora() << endl;
        interfaz.moverCursor(88, posY -= 2);
        cout << "Estado";
        interfaz.moverCursor(88, posY += 2);
        cout << (veterinario.getEstado() ? "Activo" : "Inactivo") << endl;
    }
