...
void Configuracion::listarCopiaSeguridadConsultaBK(){
    ...
    if(ptrConsultasBK == nullptr){
        ...
        while(fread(&consulta, sizeof(Consultas), 1, ptrConsultasBK)){
            cout<<"Numerop de Turno: "<<consulta.getNumeroTurno()<<endl;
            cout<<"Fecha y Hora Registro: "<<consulta.getFechaHora().mostrarFechaHora()<<endl;
            cout<<"Legajo Veterinario: "<<consulta.getLegajoVeterinarioAsignado()<<endl;
